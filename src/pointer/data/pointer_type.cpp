...
Flex<Type> PointerType::internal_resolve() const {
...
Flex<Type> PointerType::internal_remove_comptime_const() const {
...
bool PointerType::internal_unify(const Type &assignment_type) const {
...
Option<Flex<Expression>> PointerType::internal_coerce(
