...
template <typename octet_type> inline utfchar8_t mask8(octet_type oc) {
  return static_cast<utfchar8_t>(0xff & oc);
}

template <typename u16_type> inline utfchar16_t mask16(u16_type oc) {
...
template <typename octet_iterator> int sequence_length(octet_iterator lead_it) {
...
append16(utfchar32_t cp, std::back_insert_iterator<container_type> result) {
