...
public:
  ...
  SliceIterator<T> begin() { return SliceIterator(*this); }
  ConstSliceIterator<T> begin() const { return ConstSliceIterator(m_ptr, m_len); }

  SliceIterator<T> end() { return SliceIterator(m_ptr + m_len, 0); }
  ConstSliceIterator<T> end() const { return ConstSliceIterator(m_ptr + m_len, 0); }
...
public:
  ...
  SliceIterator<T> begin() { return *this; }
  ConstSliceIterator<T> begin() const { return ConstSliceIterator(m_ptr, m_len); }
  ...
  bool at_end() const noexcept override { return m_len == 0; }
...
public:
  ...
  ConstSliceIterator<T> begin() const { return *this; }

  ConstSliceIterator<T> end() const { return ConstSliceIterator(m_ptr + m_len, 0); }

  const T *ptr() const noexcept { return m_ptr; }
  ...
  bool operator!=(const ConstSlice<T> &other) const { return !(*this == other); }
...
public:
  ...
  bool operator==(const ConstSliceIterator<T> &other) const { return m_ptr == other.m_ptr; }

  bool operator!=(const ConstSliceIterator<T> &other) const { return !(*this == other); }
