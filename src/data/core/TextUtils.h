...
struct TextUtils {
  ...
  static void split(List<Text> &output, Text input, Text delimiter, int64_t max_splits = -1);
  static void split(List<String> &output, Text input, Text delimiter, int64_t max_splits = -1);
  ...
  static void find_all(List<CharIterator> &output, Text input, Text substring);
  static void find_all_bytes(List<int64_t> &output, Text input, Text substring);

  static void find_all_chars(List<CharIterator> &output, Text input, uint32_t code_point);
